...
def prediction_hits(X_train, y_train, X_test, y_test):
    ...
    params_multiclass_softmax = {
        'objective': 'multi:softmax',
        'num_class': num_classes,  # Specify the number of classes in your problem
        'eval_metric': 'mlogloss'  # Multiclass logloss evaluation metric
    }

    params_multiclass_softprob = {
        'objective': 'multi:softprob',
        'num_class': num_classes,  # Specify the number of classes in your problem
        'eval_metric': 'mlogloss'  # Multiclass logloss evaluation metric
    }

    params_multiclass_merror = {
        'objective': 'multi:softmax',  # Multi-class classification
        'num_class': num_classes,  # Number of classes in the dataset
        'eval_metric': 'merror'  # Multi-class classification error rate
    }

    params_multiclass_softprobme = {
        'objective': 'multi:softprob',
        'num_class': num_classes,  # Specify the number of classes in your problem
        'eval_metric': 'merror'  # Multiclass logloss evaluation metric
    }
