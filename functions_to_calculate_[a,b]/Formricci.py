...
def get_thresholds_forricci(num_graph, edgedata, graph_ind):
    '''
    ...
    for graph_id in range(1,num_graph + 1):
        ...
        orc = FormanRicci(graph)
        orc.compute_ricci_curvature()

        for line in np.array(graph_edges):
            ricci.append(round(orc.G[line[0]][line[1]]["formanCurvature"], 6))
...
def forricci_sub(num_graph, edgedata, graph_ind, threshold_array):
    '''
    This function calculates the vector of number of 0-cells and number of 1-cells for sub-level Forman Ricci
    ...
    for graph_id in range(1, num_graph + 1):
        ...
        for line in np.array(graph_edges):
            ...
            n2.append(line[1])
            l = n1 + n2
            result.append(round(orc.G[line[0]][line[1]]["formanCurvature"], 6))
            s = l + result
...
def forricci_super(num_graph, edgedata, graph_ind, threshold_array):
    '''
    This function calculates the vector of number of 0-cells and number of 1-cells for super-level Forman Ricci
    Curvature filtration function.The parameters are:
